...
export class PortListComponent implements OnInit {
  ...
  applyFilters(): void {
    ...
    this.filteredPorts = this.ports.filter(port => 
      port.Port_Name.toLowerCase().includes(searchTermLower) || 
      port.Country.toLowerCase().includes(searchTermLower) ||
      port.Type.toLowerCase().includes(searchTermLower) ||
      port.UN_Code.toLowerCase().includes(searchTermLower) ||
      port.Also_known_as.toLowerCase().includes(searchTermLower)
    );
